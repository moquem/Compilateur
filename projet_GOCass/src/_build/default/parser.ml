  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState9 ->
        ...
        | EOF ->
            ...
            ((let ((((_menhir_stack, _, (_2 : 'tv_ident_main)), _endpos__3_), (imp : 'tv_boption_import_fmt_)), _, (dl : 'tv_list_decl_)) = _menhir_stack in
            let _6 = () in
            let _3 = () in
            let _1 = () in
            let _v : (
...
and _menhir_goto_option_COMMA_ : _menhir_env -> 'ttv_tail -> _menhir_state -> 'tv_option_COMMA_ -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState37 ->
        ...
        let (_ : _menhir_state) = _menhir_s in
        let ((_2 : 'tv_option_COMMA_) : 'tv_option_COMMA_) = _v in
...
and _menhir_goto_option_SEMICOLON_ : _menhir_env -> 'ttv_tail -> 'tv_option_SEMICOLON_ -> 'ttv_return =
  fun _menhir_env _menhir_stack _v ->
    ...
    let ((_2 : 'tv_option_SEMICOLON_) : 'tv_option_SEMICOLON_) = _v in
    ((let (_menhir_stack, _menhir_s, (x : 'tv_ids_and_type)) = _menhir_stack in
    let _v : 'tv_fields = 
# 71 "parser.mly"
                                           ( [x]     )
...
# 4008 "parser.ml"
                        ...
                        let ((_1 : 'tv_import_fmt) : 'tv_import_fmt) = _v in
